<?php  
	...
	class Clientes extends DbConfig
	{
		...
		function ActualizarC($id_cliente, $nombre, $apellido, $dir, $tel, $correo, $id_cc)
		{
			self::setNames();
			$query = "UPDATE clientes SET id_cliente = '$id_cliente',nombre_c= '$nombre`, apellido_c = '$apellido', direccion_c = '$direccion', telefono = '$tel', correo = '$correo',tipo_cliente = '$id_cc WHERE id_cliente = '$id_cliente'";
			$result = $this->connection->query($query) or die ("Error al consultar datos".mysqli_error($this->connection));
