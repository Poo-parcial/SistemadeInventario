<?php 
	...
	elseif ($v1 >= $v2) 
	{
		...
		$query3 = "INSERT INTO detalle_orden_venta(id_orden_venta, id_producto, precio_unitario, cantidad, descuento, total, fecha, hora) 
		VALUES  ('$idorden','$id_pr', '$n_precio','$v2', '$desc', '$operacion3', '$fecha', '$hora')";
