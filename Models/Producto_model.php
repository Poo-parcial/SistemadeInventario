<?php
    ...
    class Producto extends DbConfig
    {
        ...
        {   
            self::setNames();
            $query = "INSERT INTO productos(id_producto, codigo, nombre_p, descripcion, unidad, precio_compra, precio_venta, estado, imagen, id_proveedor, id_categoria) 
            VALUES ('$id_producto', '$codigo', '$nombre', '$descripcion', '$unidad', '$precio_compra', '$precio_venta', '$estado', '$ruta', '$id_proveedor', '$id_categoria')";
