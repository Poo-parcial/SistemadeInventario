<?php
	...
	class Proveedores extends DbConfig
	{
		...
		{
			self::setNames();
			$query = "INSERT INTO proveedores(id_proveedor, nombre, direccion, telefono_fijo, celular, email, id_contacto) 
			VALUES ('$id', '$nombre', '$direccion', '$telefono_fijo', '$celular', '$email', '$id_contacto')";
