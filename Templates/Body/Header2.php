...
<body>
    <div class="wrapper">
    <div class="sidebar" data-color="blue" data-image="../../Public/Img/HD/pro.jpg">
        <div class="logo">
            <a href="../../Templates/Panel_control.php" class="simple-text">
                <img src="../../Public/Img/HD/pro.jpg" width="120px" alt="">
            </a>
        </div>
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li>
                    <a href="../../Templates/Modulos/Reporte_inv.php">
            ...
            <li>
                <a href="../Templates/Modulos/Agregar_Emp.php">
                    <i class="material-icons">view_module</i>
