          ...
          <div class="row">
              <div class="col-md-12">
                  <div class="card">
                          ...
                          <table class="table">
                              ...
                              <tbody>
                                  <tr>
                                    ...
                                    <td>entrada</td>
                                    <td>salidas</td>
                                    <td><a href="Modificar_Asis.php" class="btn btn-success btn-sm" role="button">Modificar</a></td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                      ...
                      <br><br><br><br><br><br>
                      <br><br><br><br><br><br>
                      <a href="Agregar_Asis.php"><button type="submit" class="btn btn-primary pull-right"> Registrar asistencias</button></a>
