          ...
          <div class="row">
              <div class="col-md-12">
                  <div class="card">
                          ...
                          <table class="table">
                              ...
                              <tbody>
                                  <tr>
                                    <td>#</td>
                                    <td>nombre</td>
                                    <td><a href="Modificar_Cat.php" class="btn btn-success btn-sm" role="button">Modificar</a></td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                      ...
                      <br><br><br><br><br><br>
                      <br><br><br><br><br><br>
                      <a href="Agregar_Cat.php"><button type="submit" class="btn btn-primary pull-right"> Agregar categoria</button></a>
