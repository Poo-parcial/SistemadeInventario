		                  	...
		                  	<form action="#" method="POST">
                                  ...
                                  <div class="col-md-12">
                                      <div class="form-group label-floating">
                              		 ...
                              		 <button type="submit" name="btn_cat" class="btn btn-success pull-right">Actualizar categoria</button>
                              <div class="clearfix"></div>
							</form>
							<div class="text-left">
							    <a href="../../Controllers/Controlador_Categoria.php"><button class="btn btn-danger">Cancelar</button></a>
							</div>
		                  </div>
		  		 	</div>
		  		 </div>
