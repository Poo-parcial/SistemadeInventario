                  ...
                  <div class="card">
                      ...
                      <div class="card-content">
                          <form action="#" method="POST">
                              ...
                              <button type="submit" name="btn_cat" class="btn btn-success pull-right">Agregar categoria</button>
                      ...
                      <a href="../../Controllers/Controlador_Categoria.php"> <button type="submit" class="btn btn-primary pull-left">Ver Categorias</button></a>
                  </div>
              </div>
              <div class="col-md-4">
