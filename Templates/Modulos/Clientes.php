          ...
          <div class="row">
              <div class="col-md-9">
                  <div class="card">
                          ...
                          <table class="table">
                            ...
                            ?>
                                  <tr>
                                    ...
                                    <td><a href="./Modificar.php?id_c=<?php echo $datos[$i]['id_cliente']; ?>"><button class="btn btn-success btn-sm" >Actualizar</button></a></td>
                      ...
                      <br><br>
                      <a href="Agregar.php"><button type="submit" class="btn btn-success pull-right"> Agregar cliente</button></a>
