...
<table class="table table-striped">
    ...
    <?php foreach($this->model->Listar() as $r): ?>
        <tr>
            ...
            <td>
                <a href="?c=Estudiante&a=Crud&id=<?php echo $r->id; ?>"><button class="btn btn-primary  btn-sm">Editar</button></a>
            </td>
            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=Estudiante&a=Eliminar&id=<?php echo $r->id; ?>"><button class="btn btn-danger  btn-sm">Eliminar</button></a>
            </td>
        </tr>
    <?php endforeach; ?>
