          ...
          <div class="row">
              <div class="col-md-12">
                  <div class="card">
                          ...
                          <table class="table">
                              ...
                              <tbody>
                                  <tr>
                                    <td>nombre</td>
                                    <td>fecha hora</td>
                                    <td><a href="Modificar_Ent.php" class="btn btn-success btn-sm" role="button">Modificar</a></td>
                                  </tr>
                              </tbody>
                          </table>
                      </div>
                      ...
                      <br><br><br><br><br><br>
                      <br><br><br><br><br><br>
                      <a href="Agregar_Ent.php"><button type="submit" class="btn btn-primary pull-right"> Registrar entradas</button></a>
